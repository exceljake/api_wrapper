...
RSpec.describe "Developers", type: :request do
  describe "GET /index" do
    ...
    it "JSON results response contains expected developers attributes" do
      get "https://api.rawg.io/api/developers"
      json_response = JSON.parse(response.body)
      expect(json_response["data"]["results"].first.keys).to match_array(["games", "games_count", "id", "image_background", "name", "slug"])
    end
